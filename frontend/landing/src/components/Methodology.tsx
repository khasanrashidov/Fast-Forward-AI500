        ...
        <section className="py-24 bg-white">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold font-display text-gray-900 mb-4">{t.methodology.title}</h2>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        <h3 className="text-2xl font-bold font-display text-gray-900 mb-8">{t.methodology.stepsTitle}</h3>
                    ...
                    <div className="lg:sticky lg:top-8">
                        <h3 className="text-2xl font-bold font-display text-gray-900 mb-8">{t.methodology.techStackTitle}</h3>
