          ...
          {t.team.members.map((member, index) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-gray-50 rounded-2xl p-6 border border-gray-100 transition-all duration-300 group ${
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-white shadow-sm flex-shrink-0">
                    <Image src={data.image} alt={member.name} fill className="object-cover" />
                  </div>
                  <div>
