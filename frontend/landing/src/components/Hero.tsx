    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-bold font-display tracking-tight mb-6 bg-gradient-to-r from-emerald-600 to-teal-500 bg-clip-text text-transparent pb-2 leading-tight">
            {t.hero.title}
          </h1>
