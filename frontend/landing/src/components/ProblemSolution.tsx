        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 mb-8 text-lg">{t.problemSolution.problemDesc}</p>
          ...
          >
            <div className="mb-8">
              ...
              <h2 className="text-4xl font-bold font-display text-gray-900 mt-2 mb-4">
                {t.problemSolution.meet}{' '}
                <span className="text-emerald-600">{t.problemSolution.solutionTitle}</span>
              </h2>
