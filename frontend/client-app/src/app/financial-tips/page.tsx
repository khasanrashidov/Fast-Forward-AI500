import { Lightbulb, NotebookPen, ShieldCheck, Rocket, Target, Coins, Boxes, Landmark, HandCoins } from "lucide-react";
...
export default function FinancialTipsPage() {
  const slides: TipSlide[] = [
    { title: "Start With a Clear Budget", description: tips[0].description, illustration: "/undraw_wallet_diag.svg" },
    { title: "Build an Emergency Fund", description: tips[1].description, illustration: "/undraw_vault_tyfh.svg" },
    { title: "Apply the FIRE Principle", description: tips[2].description, illustration: "/undraw_investing_uzcu.svg" },
    { title: "Avoid Bad Debt — Use Loans Wisely", description: tips[3].description, illustration: "/undraw_finance_m6vw.svg" },
    { title: "Automate Your Savings", description: tips[4].description, illustration: "/undraw_success-factors_i417.svg" },
    { title: "Invest Early and Regularly", description: tips[5].description, illustration: "/undraw_revenue_kv38.svg" },
    { title: "Educate Yourself Constantly", description: tips[6].description, illustration: "/undraw_brainstorming_gny9.svg" },
    { title: "Plan for Retirement Early", description: tips[7].description, illustration: "/undraw_personal-finance_xpqg.svg" },
    { title: "Diversify Your Assets", description: tips[8].description, illustration: "/undraw_houses_owky.svg" },
    { title: "Set SMART Financial Goals", description: tips[9].description, illustration: "/undraw_target_d6hf.svg" },
  ];
    ...
    <div className="p-6 space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="space-y-1">
          <h1 className="text-3xl font-semibold tracking-tight text-[var(--primary)]">Financial Tips</h1>
          <p className="text-muted-foreground">
            Quick, actionable guidance to strengthen your finances. Swipe through illustrations in the dialog.
          </p>
        </div>
