        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="grid grid-cols-4 gap-4">
            {[
              ...
              >
                <div
                  className={`w-14 h-14 rounded-2xl flex items-center justify-center ${action.color} shadow-sm group-hover:scale-105 transition-transform duration-200`}
                >
                  <action.icon size={24} />
                </div>
          ...
          <section>
            <div className="bg-white/70 backdrop-blur-xl border border-white/40 rounded-3xl p-6 shadow-sm relative h-full">
              <div className="flex justify-between items-center mb-4">
                ...
                <button className="text-primary text-sm font-medium bg-primary/10 px-3 py-1 rounded-full hover:bg-primary/20 transition-colors">
                  See All
                </button>
              </div>
            ...
            <div className="bg-white/70 backdrop-blur-xl border border-white/40 rounded-3xl shadow-sm overflow-hidden p-6">
              ...
              <div className="-mx-6">
                {[
                  ...
                  <div
                    key={i}
                    className="flex justify-between items-center px-6 py-4 border-b border-gray-100/50 last:border-0 hover:bg-white/40 transition-colors"
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${tx.color}`}
                      >
                        <tx.icon size={18} />
                      </div>
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          <span
                            className={`text-[10px] px-1.5 py-0.5 rounded-full font-medium ${tx.color
                              .replace("text-", "text-opacity-80 text-")
